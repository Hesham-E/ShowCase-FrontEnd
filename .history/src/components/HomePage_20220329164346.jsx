    ...
    return (
        ...
        <div id="index-bg">
            ...
            <div class="jumbotron text-center">
                <div class="container">
                    <h1 className="WebTitle"><big><big>SH&#128188;W CASE</big></big></h1>
                    <h4 className="IntroText">Hello and welcome to Show Case! A website where you can host your own portfolio and view the portfolio of others. To use our website, you must first make an account. However, you are always welcome to search for other users without making one.</h4>
                    <hr class="my-4"></hr>
                    <p> Our Main Store:
